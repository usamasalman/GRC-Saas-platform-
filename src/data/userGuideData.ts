...
export const USER_GUIDE_DATA: Record<string, TabGuideItem> = {
  ...
  risk: {
    ...
    proTips: [
      'Risks with score > Board Tolerance cannot be accepted and MUST be treated down.',
      'Use the 5x5 heatmap and Connectedness network tab to spot risks sharing common single points of failure.'
    ],
    relatedTabs: [
      { id: 'controls', title: 'Control Library' },
      { id: 'implementations', title: 'Implementations & Evidence' },
  ...
  audits: {
    ...
    summary: 'End-to-end Internal Audit lifecycle management: Universe risk scoring, Annual Audit Plan approval, Engagement instantiation, Risk & Control Matrix (RCM), Workpapers, and Finding/Issue tracking.',
    ...
    proTips: [
      'Export the full Risk & Control Matrix (RCM) as an Excel/Word document with 1 click.',
